...
var propTypes = _extends({}, _simpleReactForm.FieldType.propTypes, {
   ...
   */
  previewStyles: _propTypes2.default.object,

  /**
   * This delete the files that are not used
   */
  deleteNotUsedFiles: _propTypes2.default.bool,

  /**
   * The label of the button
   */
  uploadLabel: _propTypes2.default.any,

  /**
   * The label of the delete button
   */
  deleteLabel: _propTypes2.default.any,

  /**
   * The text that is shown when deleting
   */
  confirmDeleteText: _propTypes2.default.any
});
