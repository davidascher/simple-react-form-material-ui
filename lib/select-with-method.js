...
var propTypes = _extends({}, _simpleReactForm.FieldType.propTypes, {
   ...
   */
  methodName: _propTypes2.default.string.isRequired,
  /**
   ...
   */
  labelMethodName: _propTypes2.default.string.isRequired,
  /**
   * A Meteor connection.
   */
  connection: _propTypes2.default.any,
  /**
   ...
   */
  createLabel: _propTypes2.default.func,
  /**
   * A function that returns if a value can be created
   */
  canCreate: _propTypes2.default.func
});
